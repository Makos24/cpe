        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('user.create')}}" method="post">
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Admin Type') }}</label>

                        <div class="col-md-6">
                            <select name="level" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" required autofocus>
                                <option value="">Select Admin Type</option>
                                    <option value="1">Active Admin</option>
                                    <option value="2">Passive Admin</option>
                            </select>
                            @if ($errors->has('level'))
                                <span class="invalid-feedback" role="alert">
