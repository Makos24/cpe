                    ...
                    <div class="container" style="margin-top: 10px">
                        ...
                        <div class="form-group row">
                            <div class="media">
                                @if ($user->image)
                                <div class="col-md-6">
                                    <img class="media-object" alt="" src="{{url('storage/users/'.$user->image)}}" width="120" height="120">
                                </div>
                                @else
                                <div class="col-md-6">
                                    <img class="media-object" alt="{{'no image'}}" src="{{asset("images/mm.jpg")}}" width="120" height="120">
                        ...
                        <form method="POST" action="{{''}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('nickname') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" id="nickname" name="nickname" value="{{old('nickname') ? : $user->nickname }}" readonly>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('facebook_username') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" id="mname" name="facebook_username" value="{{old('facebook_username') ? : $user->facebook_username }}" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="dob" class="form-control" id="dob" value="{{old('dob') ? : $user->dob}}" readonly>
                                            @if ($errors->has('dob'))
                                            <span class="help-block">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('marital_status') ? ' has-error' : '' }}">
                                            ...
                                            <select class="form-control" name="marital_status" readonly>
                                                ...
                                                <option value="{{$title['value']}}" {{Auth::user()->marital_status == $title['value'] ? 'selected' : ''}}>
                                                    {{$title['title']}}
                                                </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control" type="email" value="{{old('email') ? : $user->email}}" readonly>
                                            @if ($errors->has('email'))
                                            <span class="help-block">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="phone" class="form-control" id="phone" value="{{old('phone') ? : $user->phone }}" readonly>
                                            @if ($errors->has('phone'))
                                            <span class="help-block">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('alt_phone') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="alt_phone" class="form-control" id="alt_phone" value="{{old('alt_phone') ? : $user->alt_phone }}" readonly>
                            ...
                            <fieldset class="form-group">
                                <legend>Moments/Experiences:</legend>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('best_course') ? ' has-error' : '' }}">
                                            <label for="best_course" class="control-label">Best Course(s)<span style="color: red">*</span></label>
                                            <input type="text" class="form-control" id="best_course" name="best_course" value="{{old('best_course') ? : $user->best_course }}" readonly>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('best_lecturer') ? ' has-error' : '' }}">
                                            <label for="nickname" class="control-label">Best Lecturer(s)<span style="color: red">*</span></label>
                                            <input type="text" class="form-control" id="best_lecturer" name="best_lecturer" value="{{old('best_lecturer') ? : $user->best_lecturer }}" readonly>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('worst_course') ? ' has-error' : '' }}">
                                            <label for="worst_course" class="control-label">Worst Course(s)</label>
                                            <input type="text" class="form-control" id="worst_course" name="worst_course" value="{{old('worst_course') ? : $user->worst_course }}" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('best_moment') ? ' has-error' : '' }}">
                                            <label for="best_moment" class="control-label">Best Moment(s)<span style="color: red">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('most_admired') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control" type="text" value="{{old('most_admired') ? : $user->most_admired}}" readonly>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('role_model') ? ' has-error' : '' }}">
                                            ...
                                            <input type="email" name="role_model" class="form-control" id="role_model" value="{{old('role_model') ? : $user->role_model }}" readonly>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('future_aspiration') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="future_aspiration" class="form-control" id="future_aspiration" value="{{old('future_aspiration') ? : $user->future_aspiration }}" readonly>
