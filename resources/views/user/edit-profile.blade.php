                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('facebook_username') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" id="mname" name="facebook_username" value="{{old('facebook_username') ? : $user->facebook_username }}" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="dob" class="form-control" id="dob" value="{{old('dob') ? : $user->dob}}" required>
                                            @if ($errors->has('dob'))
                                            <span class="help-block">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control" type="email" value="{{old('email') ? : $user->email}}" required>
                                            @if ($errors->has('email'))
                                            <span class="help-block">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('alt_phone') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="alt_phone" class="form-control" id="alt_phone" value="{{old('alt_phone') ? : $user->alt_phone }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('best_course') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" id="best_course" name="best_course" value="{{old('best_course') ? : $user->best_course }}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('best_lecturer') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" id="best_lecturer" name="best_lecturer" value="{{old('best_lecturer') ? : $user->best_lecturer }}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('worst_course') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" id="worst_course" name="worst_course" value="{{old('worst_course') ? : $user->worst_course }}" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group{{ $errors->has('worst_moment') ? ' has-error' : '' }}">
                                            <label for="worst_moment" class="control-label">Worst Moment(s)<span style="color: red">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('most_admired') ? ' has-error' : '' }}">
                                            ...
                                            <input class="form-control" type="text" name="most_admired" value="{{old('most_admired') ? : $user->most_admired}}" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('role_model') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="role_model" class="form-control" id="role_model" value="{{old('role_model') ? : $user->role_model }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('future_aspiration') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="future_aspiration" class="form-control" id="future_aspiration" value="{{old('future_aspiration') ? : $user->future_aspiration }}" required>
